...
traindatadir='F:/学习文档/机器学习/MachineLearningTrainData/'
...
def datingClassTest():
    ...
    # 从文件中加载数据
    datingDataMat, datingLabels = file2matrix(traindatadir+'datingTestSet2.txt')  # load data setfrom file
    # 归一化数据
...
def clasdifyPerson():
    ...
    datingDataMat, datingLabels = file2matrix(traindatadir+'datingTestSet2.txt')
    normMat, ranges, minVals = autoNorm(datingDataMat)
...
#file2matrix(traindatadir+'datingTestSet2.txt')
#datingClassTest()
clasdifyPerson()