...
def meituan_frist(url):
        ...
        #for i in range(len(img_address)-len(shop_address)):
         #   print(img_address[0])
          #  img_address.remove(img_address[0])
...
def shop_info(url):
    ...
    '''
    try:
        with open('C:/Users/Administrator/Desktop/test2.csv', 'a', newline='') as csvfile:
            spamwriter = csv.writer(csvfile, delimiter=',', quotechar='|', quoting=csv.QUOTE_MINIMAL)
            for i in shop_list:
             spamwriter.writerow(i)
        time.sleep(10)
    except:
        with open('C:/Users/Administrator/Desktop/shop1.txt', 'w', encoding='utf-8') as f:
            # spamwriter = csv.writer(csvfile, delimiter=',', quotechar='|', quoting=csv.QUOTE_MINIMAL)
...
#def user_content(url):
    ...
    try:
        ...
        with open('C:/Users/Administrator/Desktop/shop_content1.txt', 'w', encoding='utf-8') as f:
            # spamwriter = csv.writer(csvfile, delimiter=',', quotechar='|', quoting=csv.QUOTE_MINIMAL)
...
#def shop_similar(url):
    ...
    try:
        ...
        with open('C:/Users/Administrator/Desktop/shop_similar1.txt', 'w', encoding='utf-8') as f:
            # spamwriter = csv.writer(csvfile, delimiter=',', quotechar='|', quoting=csv.QUOTE_MINIMAL)
...
#with open('C:/Users/Administrator/Desktop/test2.csv', 'w') as csvfile:
#    pass
shop_info('http://cd.meituan.com/shop/4505001')

#with open('C:/Users/Administrator/Desktop/test2.txt', 'r',encoding='utf-8') as f:
#    for line in f:
#        print(list(line))
#        with open('C:/Users/Administrator/Desktop/test2.csv', 'w', newline='') as csvfile:
#            spamwriter = csv.writer(csvfile, delimiter=',', quotechar='|', quoting=csv.QUOTE_MINIMAL)
