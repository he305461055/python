...
def createTree(dataSet, labels):
    ...
    #删除labels[bestFeat] 里的值，及no surfacing 被删除了
    ...
    for value in uniqueVals:
        # 求出剩余的标签label,no surfacing已经在上面被删除了
...
def ContactLensesTest():
    ...
    # 加载隐形眼镜相关的 文本文件 数据
    fr = open('F:/学习文档/机器学习/MachineLearning-master/input/3.DecisionTree/lenses.txt')
    # 解析数据，获得 features 数据
